...
Most of the datasets used in my other research are available through the [Harvard Dataverse](https://dataverse.harvard.edu/dataverse/harvard/?q=ranjit+lall).

### software


**[MIDASverse](https://github.com/MIDASverse)**: software for missing-data imputation and conditional independence testing with machine learning
...
**[citest](https://cran.r-project.org/web/packages/citestR/index.html)** — Python (PyPI): tests conditional independence in incomplete regression analysis with machine learning methods. With Thomas Robinson.
**[citestR](https://cran.r-project.org/web/packages/citestR/index.html)** — R (CRAN): R equivalent of citest. With Thomas Robinson.
**[MIDASpy](https://github.com/rMIDAS)** — Python (PyPI): accurate and efficient multiple imputation with deep learning methods. With Thomas Robinson and Alex Stenlake.
**[rMIDAS](https://github.com/MIDASp)** — R (CRAN): R equivalent of MIDASpy. With Thomas Robinson and Alex Stenlake.
